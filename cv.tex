...
\section{Skills}
\createskills{
    \createskill{Programming Languages}{Python (FastAPI, Flask) \cpshalf React \cpshalf Go \cpshalf C++ \cpshalf TypeScript \cpshalf Java \cpshalf Bash \cpshalf SQL \cpshalf Android \cpshalf Lua},
    ...
    \createskill{AI \& Engines}{LLM \& Coding Assistant (OpenAI / Claude) \cpshalf RAG \cpshalf Pinecone \cpshalf Unity \cpshalf UE5 \cpshalf Figma \cpshalf Linear},
    \createskill{Practices}{CI/CD \cpshalf QA Automation \cpshalf Prompt Engineering \cpshalf Product Management \cpshalf Leadership \cpshalf Agile}
}
\vspace{-3mm}
